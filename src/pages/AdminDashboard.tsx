...
import { Clock, Timer, CalendarDays, Users, Filter } from "lucide-react";
    ...
    <div className="min-h-screen bg-muted/30">
        ...
        <div className="flex items-center gap-4">
          {companyData && (
            <Badge variant="outline" className="text-xs">
              {companyData.subscription_status === "trialing" ? "Trial" : companyData.plan_type}
            </Badge>
          )}
      ...
      <main className="max-w-6xl mx-auto p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-medium text-muted-foreground">Currently Working</CardTitle>
              <Timer className="w-4 h-4 text-muted-foreground" />
            </CardHeader>
            <CardContent>
              <p className="text-2xl font-bold">{activePunches}</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2">
